      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('cars.store')}}" method="post" class="px-md-5" enctype="multipart/form-data">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="{{__('cars.placeholder')}}" class="form-control py-2" name="cartitle" value="{{old('cartitle')}}"/>
              @error('cartitle')
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number" step="0.1" placeholder="{{__('cars.placeholderprice')}}" class="form-control py-2" name="price" value="{{old('price')}}" />
              @error('price')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <select name="category_id" id="" class="form-control">
                <option value="">{{__('cars.placeholdercategory')}}</option>
        ...
        <hr>
              ...
              <div class="form-group" >
                <label class="control-label col-sm-2" for="image">{{__('cars.addimage')}}</label>
                <div class="col-sm-10">
