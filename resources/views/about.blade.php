...
<header class="site-header section-padding-img site-header-image">
    ...
    <img src="{{asset('assets/images/cody-lannom-G95AReIh_Ko-unsplash.jpeg')}}" class="header-image img-fluid" alt="">
</header>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4 col-12">
                <div class="team-thumb d-flex align-items-center">
                    <img src="{{asset('assets/images/cody-lannom-G95AReIh_Ko-unsplash.jpeg')}}" class="img-fluid custom-circle-image team-image me-4" alt="">
                ...
                <div class="slick-testimonial">
                    <div class="slick-testimonial-caption">
                        ...
                        <div class="slick-testimonial-client d-flex align-items-center mt-4">
                            <img src="{{asset('assets/images/cody-lannom-G95AReIh_Ko-unsplash.jpeg')}}" class="img-fluid custom-circle-image me-3" alt="">
